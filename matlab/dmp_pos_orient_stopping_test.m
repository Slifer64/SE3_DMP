...
while (true)
    ...
    dP_robot = dP + dP_f;
    ddP_robot = ddP + ddP_f;
    Q_robot = quatProd(Q,Q_f); % multiply by Qf from right as Q_f is a rotation(dispacement) expressed in the moving frame not the inertia frame!
